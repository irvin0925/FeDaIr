...
<div class="mt-2 box-center-h box-register text-accent border-solid border-w-1">
    ...
    <div class="form-group">
        <label for="ced" class="text-accent">Cedula</label>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="usuario" class="text-accent">Usuario</label>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="button" value="Registrase" class="btn btn-success d-block w-100 mb-0">
    </div>
    <div class="form-group">
        <p class="text-center d-block text-accent">Ya tiene cuenta?</p><a href="http://<?= $_SERVER['HTTP_HOST']; ?>/Views/login.php">&nbsp; Inicia sesion</a>
    </div>
</div>